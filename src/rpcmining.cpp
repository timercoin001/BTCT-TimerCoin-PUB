...
Value getgenerate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "It is set with the command line argument -gen (or timercoin.conf setting gen)\n"
...
// NOTE: Unlike wallet RPC (which use BTCT values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
