...
//    if (halvings >= 32)//20190225->64->32
//        return nFees;

//    // Subsidy is cut in half every 210,000 blocks which will occur approximately every 4 years.

//    nSubsidy >>= (halvings*2);//20190225,1->2

//    return nSubsidy + nFees;
//}

//20190301 simon change to sine
CAmount GetBlockValue(int nHeight, const CAmount& nFees)
{
    CAmount nSubsidy = 100 * COIN;
    double halvings = (double)nHeight / Params().SubsidyHalvingInterval();// height/210000
    ...
    // Subsidy is cut in half every 210,000 blocks which will occur approximately every 4 years.
     ...
     nSubsidy = COIN * ( 100 * pow(0.99999, nHeight<101?0:nHeight-100) );//
